   ...
   const updateUserProfile = async () => {
      ...
      try {
         const data = await axios.put(
            `https://intercord-server.vercel.app/api/${user.role}/updateprofile`,
            {
               ...userDetails,
            },
            {
                  ...
                  {!loading ? (
                     <>
                        ...
                        <input
                           type='text'
                           id='github'
                           className='bg-gray-200 rounded-md py-2 text-black text-[16px] px-2 font-[400] w-[90%] lg:w-[20rem] italic outline-none'
