...
const Requests = () => {
   ...
   const handleAccept = async (username: string) => {
      try {
         const res = await axios.get(
            `https://intercord-server.vercel.app/api/teacher/allow/${username}`,
            {
               headers: {
   ...
   const handleReject = async (username: string) => {
      try {
         const res = await axios.get(
            `https://intercord-server.vercel.app/api/teacher/reject/${username}`,
            {
               headers: {
                  Authorization: `Bearer ${userInfo.token}`,
               },
   ...
   const getAllPendingStudents = async () => {
      const res = await axios.get(
         'https://intercord-server.vercel.app/api/teacher/allrequest',
         {
            headers: {
               Authorization: `Bearer ${userInfo.token}`,
            },
