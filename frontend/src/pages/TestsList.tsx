...
const TestsList = () => {
  ...
  return (
    <div className="w-full font-bona h-full pl-[2rem] lg:pl-[6rem] pt-[2rem] pr-[1rem] sm:pr-[2rem] flex flex-col gap-4 tracking-wider">
      <div className="flex mt-4 pl-1 gap-4">
        <button
          className={`flex items-center hover:bg-gray-300 transition-colors duration-300 py-1 px-2 rounded-md gap-1 italic font-bold text-xs md:text-[1rem] md:text-lg-+ ${
        ...
        <button
          className={`flex items-center hover:bg-gray-300 transition-colors duration-300 py-1 px-2 rounded-md gap-1 italic font-bold text-xl sm:text-[1rem] ${
        ...
        <button
          className={`flex items-center hover:bg-gray-300 transition-colors duration-300 py-1 px-2 rounded-md gap-1 italic text-xl sm:text-[1rem] font-bold ${
